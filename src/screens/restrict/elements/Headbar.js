    ...
    return (
        <Menu fixed='top' color='orange' inverted>
            <Container>
                ...
                <Menu.Item as={Link} to='/restrict'>Todas Receitas</Menu.Item>
                <Menu.Item as={Link} to='/restrict/my'>Minhas Receitas</Menu.Item>
                <Menu.Menu position='right'>
                    <Dropdown item text={props.auth.user.name}>
                        <Dropdown.Menu>
                            {props.auth.user.role === 'admin' && <Dropdown.Item as={Link} to='/admin'>Modo: Admin</Dropdown.Item>}
